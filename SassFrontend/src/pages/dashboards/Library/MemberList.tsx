  ...
  return (
    <div className="p-6" style={{height:"100vh"}}>
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        ...
        {/* Filters */}
        <select
          className="px-4 w-40 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
      ...
      <div className="overflow-x-auto shadow-lg">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium bg-teal-50 text-gray-700 uppercase tracking-wider">
                Member
              </th>
              <th className="px-6 py-3 text-left text-xs font-medium bg-teal-50 text-gray-700 uppercase tracking-wider">
                Seat Number
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {currentMembers.map((member) => (
              <tr key={member.id} className="hover:bg-gray-50 cursor-pointer bg-white">
                <td className="px-6 py-4 whitespace-nowrap" onClick={() => navigate(`${member.id}`)}>
                  <div className="flex items-center">
                    <div className="flex-shrink-0 h-10 w-10 bg-gradient-to-br from-teal-400 to-teal-600 rounded-full flex items-center justify-center text-white text-xs font-semibold">
      ...
      <div className="flex items-center justify-between mt-6">
        <div className="text-sm text-gray-600">
          ...
          of <span className="font-medium text-gray-900">{filteredMembers.length}</span>{" "}
          results
        </div>
        <div className="flex space-x-2">
            ...
            className="px-3 py-1 border border-gray-300 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed bg-teal-600 text-white hover:bg-teal-700 transition-colors"
                >
            Previous
                </button>
