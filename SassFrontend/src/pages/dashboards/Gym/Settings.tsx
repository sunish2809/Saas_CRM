...
const Settings = () => {
  ...
  // Validation for Save Profile button
  const isProfileValid = settings.ownerName.trim() !== '' && settings.email.trim() !== '';

  // Validation for Change Password button
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-2">Manage your gym account and preferences</p>
      </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pr-10 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-100 transition-colors"
              />
              <button
                type="button"
